...
namespace EduWeb.Categories
{
    public partial class Category : System.Web.UI.Page
    {
        ...
        End: ;
            Response.Write(String.Format(
                "<table style=\"width:100%;text-align:center;margin-top:80px\"><tr>" +
                "<td><a href=\"?start=1\">Newest</a></td>" +
                "<td><a href=\"?start={0}\">Newer</a></td>" +
                "<td><a href=\"?start={1}\">Older</a></td>" +
                "<td><a href=\"?start={2}\">Oldest</a></td>" +
                "</tr></table>", start > perPage ? start - perPage : 1, start + perPage, num > perPage ? num - perPage : 1));
        }
    }
}